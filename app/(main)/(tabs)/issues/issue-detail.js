...
import * as Location from 'expo-location'; // ­ƒôì IMPORTED FOR NATIVE GPS
...
export default function IssueDetailScreen() {
  ...
  // ­ƒôì NEW CAMERA & LOCATION STATES
  ...
  const handleSubmitPhoto = () => {
    console.log("\n=============================================");
    console.log("­ƒô© FIX PHOTO UPLOADED");
  ...
  // ÔöÇÔöÇ SMART DATA EXTRACTION ÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ ROLE + STATUS DERIVED FLAGS ÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ PREMIUM ZOHO-INSPIRED CARD COLORS ÔöÇÔöÇ
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: bgColor }]}>
      ...
      >
        ...
        <View style={styles.actions}>
          ...
          {/* ­ƒôì PROBLEM SOLVER: Camera Flow (IN_PROGRESS) */}
          {showMarkDoneBtn && (
          ...
          {/* ­ƒôì SUPERVISOR / MANAGER: Approve/Reject (RESOLVED_PENDING_REVIEW) */}
          {showApproveBtn && (
